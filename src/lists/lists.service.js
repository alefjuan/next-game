...
var ListsService = function () {
    ...
    var ListsService = _classThis = /** @class */ (function () {
        function ListsService_1() {
            this.lists = [];
        }
        ListsService_1.prototype.create = function (list) {
            this.lists.push(list);
            return list;
        };
        ListsService_1.prototype.findOne = function (id) {
            return this.lists.find(function (list) { return list.id === id; });
        };
