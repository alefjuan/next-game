...
var ListsController = function () {
    var _classDecorators = [(0, common_1.Controller)('lists')];
    ...
    var ListsController = _classThis = /** @class */ (function () {
        ...
        ListsController_1.prototype.create = function (createListDto) {
            return this.listsService.create(createListDto);
        };
        ListsController_1.prototype.findOne = function (id) {
